...
<div class="flex flex-col items-center justify-center w-full gap-y-8">
    <h1 class="w-2/3 md:w-1/2 text-2xl font-bold text-center md:text-4xl md:w-1/3">{{ $slide->project->heading }}</h1>

    <p class="w-2/3 md:w-1/2 text-xl text-center normal-case md:w-1/4">
    ...
    <div class="flex no-slide mx-auto text-center mt-8 font-bold text-xs sm:text-sm lg:text-base  gap-x-12 w-full sm:w-2/3 md:w-1/2 px-6 md:px-12 text-{{ $textColor }}">
        <a
