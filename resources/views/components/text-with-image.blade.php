...
<div class="flex flex-col lg:flex-row flex-col-reverse justify-between w-3/4 max-h-[80vh] lg:max-h-[60vh] gap-8">
    ...
    <div class="justify-center w-full no-scroll lg:w-2/3 p-2 lg:p-8 mx-auto h-[90vh] md:h-[60vh] overflow-scroll text-ellipsis text-sm md:text-base lg:text-lg text-center border-0 shadow-xl rounded-xl bg-{{ $textColor }} text-{{ $bgColor }}">
